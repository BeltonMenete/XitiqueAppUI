...
export function RegisterSaverModal({ isOpen, onClose, onSubmit }: RegisterSaverModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Registar Novo Ticante" size="lg">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="cardNumber" className="block text-xs font-semibold text-slate-700 mb-1">
              Número de Cartão *
            </label>
            <input
              id="cardNumber"
