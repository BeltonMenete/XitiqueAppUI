...
export function DepositHistory({
	...
	const mockDeposits: Deposit[] = [
		...
		},
		{
			...
			status: "deleted",
			day: 8,
			deletionMotive: "Erro de registo",
		},
		{
			id: "9",
			date: "09/05/2024",
			...
			<CardContent>
				...
				<div className="grid grid-cols-4 gap-4 mb-6">
					...
					<div className="p-3 bg-amber-50 rounded-lg border border-amber-200">
						<p className="text-[10px] uppercase font-bold text-amber-600 tracking-wider mb-1">
							Parciais
						</p>
					...
					<div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
						...
						<p className="font-mono text-lg font-bold text-slate-600">
							{unpaidDays} dias
						</p>
					</div>
				</div>
								...
								<div>
									...
									{deposit.collectorAgent && (
										<p className="text-[10px] text-slate-400">
											Cobrador: {deposit.collectorAgent}
										</p>
									)}
