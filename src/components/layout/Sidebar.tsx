...
export function Sidebar({ items, className = "" }: SidebarProps) {
  return (
    <aside className={cn("hidden md:flex flex-col w-64 bg-white border-r border-slate-200/80 justify-between p-6 select-none shrink-0", className)}>
      <div className="space-y-7">
        ...
        <div className="flex items-center gap-2.5 px-2">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-extrabold tracking-tight text-slate-950">Xitique</span>
            <span className="text-[10px] text-slate-400 font-medium tracking-wide">Gestor de Poupança</span>
          </div>
        </div>
