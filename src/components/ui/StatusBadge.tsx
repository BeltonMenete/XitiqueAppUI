...
export function PendingBadge({ children = "Pendente" }: { children?: ReactNode }) {
  return <StatusBadge status="warning">{children}</StatusBadge>;
}

export function DebtBadge({ children = "Em Dívida" }: { children?: ReactNode }) {
...
export function InactiveBadge({ children = "Inactivo" }: { children?: ReactNode }) {
