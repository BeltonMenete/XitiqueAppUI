...
function ResetPassword() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (password.length < 8) {
      ...
      newErrors.password = 'A senha deve conter maiúsculas, números e caracteres especiais.';
    }
    ...
    if (!token && password === confirmPassword && password.length >= 8) {
      newErrors.password = 'Sessão de redefinição inválida ou expirada. Volte a solicitar o código.';
    }
    ...
    try {
      ...
      setIsLoading(false);
      setErrors({ password: 'Ocorreu um erro ao atualizar a senha. Tente novamente.' });
    }
  };
            ...
            {isSuccess ? (
              ...
              <div className='text-center space-y-4 animate-in fade-in zoom-in duration-300'>
                ...
                <p className='text-gray-500 text-sm max-w-xs mx-auto'>
                  ...
                  <strong className='text-gray-800 font-medium'>{identifier || 'associada'}</strong> foi
                  alterada com êxito. A redirecionar...
                </p>
                <div className='pt-2'>
                  <Link
                    to='/login'
              ...
              <>
                ...
                <div className='flex justify-between items-center mb-0.5'>
                  <div className='flex items-center gap-2'>
                    <img src='/xitique-logo.svg' alt={APP_NAME} width={28} height={28} className='w-7 h-7' />
                ...
                <div className='space-y-3'>
                  <div>
                    <h1 className='text-xl font-semibold text-gray-900 mb-0.5'>Definir nova senha</h1>
                    <p className='text-gray-500 text-[11px]'>
                      Escolha uma palavra-passe forte contendo letras maiúsculas, números e caracteres
                      especiais.
                    </p>
                  </div>

                  {/* ELEMENTO VISUAL EXCLUSIVO: Identificador da Conta em Edição */}
                  {identifier && (
