...
import { APP_NAME, LOGIN_SUBMIT_DELAY } from "#/lib/constants";
						...
						{isSuccess ? (
							...
							<div className="text-center space-y-4 animate-in fade-in zoom-in duration-300">
								...
								<p className="text-gray-500 text-sm max-w-xs mx-auto">
									A palavra-passe para a conta{" "}
									<strong className="text-gray-800 font-medium">
										{identifier || "associada"}
									</strong>{" "}
									foi atualizada com sucesso. A redirecionar...
								</p>
								<div className="pt-2">
									<Link
										to="/login"
										...
										{isLoading ? (
											<div className="flex items-center justify-center gap-2">
												<Ring2
													...
													color="white"
												/>
												<span>A atualizar a palavra-passe...</span>
											</div>
										) : (
