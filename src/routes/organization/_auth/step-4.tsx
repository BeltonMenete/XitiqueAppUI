  ...
  return (
    <div className='h-screen max-h-screen w-screen flex overflow-hidden bg-white selection:bg-emerald-900/10'>
      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 bg-gray-50/50 h-full overflow-y-auto'>
        <div className='w-full max-w-md my-auto py-2 transition-all duration-500 ease-out animate-in fade-in slide-in-from-bottom-4 duration-700'>
          {/* Stepper */}
          <div className='flex justify-between items-center mb-1.5 select-none'>
            <span className='text-xs font-bold text-emerald-700 tracking-wider'>PASSO 4 DE 5</span>
          ...
          <h2 className='text-xl sm:text-2xl font-bold text-gray-900 mb-1 tracking-tight'>Confirmação de Dados</h2>
            ...
            <div className='relative p-4 rounded-xl border-2 border-emerald-500 bg-emerald-50/40 shadow-sm shadow-emerald-700/5 transition-all duration-300 group'>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <p className='text-xs text-emerald-600/90 font-medium mt-0.5'>{plan.details}</p>
                </div>
                <button
                  type='button'
