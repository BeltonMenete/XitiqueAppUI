         ...
         <div className="hidden lg:flex lg:w-1/2 bg-emerald-900 text-white p-12 flex-col justify-between">
            <div>
               ...
               <p className="text-emerald-100 text-lg">
                  Modernize a gestão da sua comunidade financeira. Unimos tradição Moçambicana com a eficiência da tecnologia moderna.
               </p>
            </div>
         ...
         <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div className="w-full max-w-md">
               ...
               <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-semibold text-gray-600">PASSO 1 DE 4</span>
               ...
               <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     ...
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Cidade / Distrito</label>
                        <select
                           value={form.distrito}
               ...
               <div className="mt-8 pt-6 border-t text-center text-sm text-gray-600">
                  Já tem uma conta? <a href="/login" className="font-bold text-emerald-600 hover:underline">Entrar agora</a>
               </div>
            </div>
         </div>
      </div>
