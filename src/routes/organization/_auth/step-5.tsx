        ...
        <div className='w-full max-w-xl mx-auto my-auto space-y-6'>
            ...
            <div className='flex items-center justify-between mb-1.5'>
              <div className='flex flex-col'>
                ...
                <span className='text-sm text-gray-900 font-medium mt-0.5'>
                  Escolha como deseja ativar sua conta
                </span>
              </div>
          ...
          <div className='space-y-3'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
              ...
              >
                <div
                  className={`w-12 h-12 flex items-center justify-center rounded-xl border flex-shrink-0 transition-colors ${selectedMethod === 'card' ? 'bg-emerald-100 text-emerald-700 border-emerald-200' : 'bg-gray-50 text-gray-500 border-gray-200'}`}
                >
              ...
              >
                <div
                  className={`w-12 h-12 flex items-center justify-center rounded-xl border flex-shrink-0 transition-colors ${selectedMethod === 'bank' ? 'bg-emerald-100 text-emerald-700 border-emerald-200' : 'bg-gray-50 text-gray-500 border-gray-200'}`}
                >
