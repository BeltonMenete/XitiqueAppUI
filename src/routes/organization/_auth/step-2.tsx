        ...
        <div className='h-screen max-h-screen w-screen flex overflow-hidden bg-white selection:bg-emerald-900/10'>
            ...
            <div className='w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-gray-50/50 h-full overflow-x-hidden overflow-y-auto'>
                <div className='w-full max-w-md my-auto'>
                    {/* Stepper atualizado para a proporção exata de 2/5 */}
                    ...
                    <form onSubmit={handleSubmit} className='space-y-4'>
                        ...
                        {/* Navigation Actions split in a grid layout */}
                        <div className='grid grid-cols-3 gap-3 pt-2'>
                            ...
                            <button
                                type='submit'
                                className='col-span-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition shadow-sm hover:shadow active:scale-[0.99] text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500'
                            >
