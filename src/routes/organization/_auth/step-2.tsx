...
import { FormError } from "#/components/FormError"; // Alinhado com o Passo 1
...
function StepTwo() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // 1. Validação do Nome do Responsável
    if (
            ...
            <div className="group flex flex-col">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-9 pr-3 py-2.5 text-sm border rounded-lg focus:outline-none bg-white transition-all duration-200 ${
