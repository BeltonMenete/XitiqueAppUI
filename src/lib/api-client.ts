...
import { getEndpointUrl, getAuthHeaders, API_CONFIG, APIError, NetworkError, ValidationError } from './api-config';
...
export const api = {
  ...
  getPaginated: <T>(endpoint: string, params?: PaginationParams & Record<string, unknown>) =>
